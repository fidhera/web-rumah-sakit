    ...
    <div class="max-w-4xl mx-auto my-8 p-6 bg-white shadow-lg rounded-lg">
        ...
        <tbody>
            @foreach ($antrians as $antrian)
                        <button type="button" onclick="showDetail({{ json_encode($antrian) }})"
        ...
        {{-- <h3 class="text-xl font-semibold text-center mb-4 mt-5">Antrian Saat Ini</h3>
            ...
            <tbody>
                @foreach ($antrians as $antrian)
                    <tr>
                        ...
                        <td class="px-4 py-2 border">{{ $antrian->nama_dokter }}</td>
